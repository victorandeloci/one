<div class="team-member">
    ...
    <div class="links">
        ...
        <?php if (!empty(get_post_meta(get_the_ID(), 'twitter', true))) : ?>
            <a href="<?= get_post_meta(get_the_ID(), 'twitter', true) ?>" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if (!empty(get_post_meta(get_the_ID(), 'link', true))) : ?>
            <a href="<?= get_post_meta(get_the_ID(), 'link', true) ?>" target="_blank" rel="noopener noreferrer">
