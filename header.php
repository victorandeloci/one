...
<html lang="pt-br" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="<?= get_template_directory_uri() ?>/plugins.min.css?v=1.1.0">
    <link rel="stylesheet" href="<?= get_template_directory_uri() ?>/style.css?v=1.1.0">

    <script src="<?= get_template_directory_uri() ?>/plugins.min.js?v=1.1.0" charset="utf-8" defer></script>
    <script src="<?= get_template_directory_uri() ?>/main.min.js?v=1.1.0" charset="utf-8" defer></script>
  </head>
  <body>
    <nav>
      <div class="container">
